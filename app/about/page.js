...
export default function Page() {
    return (
        <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
            ...
            {/* TO DEMONSTRATE HOW TO HANDLE AN IMAGE THAT CANNOT BE IMPORTED, E.G. COMING FROM A DATABASE */}
            {/* aspect ratio - pretty cool overlooked css property that can set size, e.g. here ratio 1:1  */}
